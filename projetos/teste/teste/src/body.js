...
function body(props) {
  const cardsData = [
    ...
    { launchDate: 2011, chronology: 6, dataFirst: './image/Thor_Official_Poster.png', category:'filmes', title:'Thor', descricao: 'Quando é banido do reino de Asgard e exilado na Terra, o arrogante guerreiro Thor (Chris Hemsworth) é obrigado a lutar para reaver seus poderes perdidos.', avaliacao: 0, critica: 0  },
